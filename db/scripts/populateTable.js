...
async function populateMoodTable() {
  for (let i = 0; i < sampleData.length; i++) {
    ...
    const res = await query(
      `INSERT INTO dailymood (userid, name, week, day, learned, revise, mood, feeling) VALUES($1,$2,$3,$4,$5,$6,$7,$8)`,
      [userid, name, week, day, learned, revise, mood, feeling]
    );
    //Added console output of what has been added
    console.log(res);
  }
}
